...
# --- IMPORTAZIONE SICURA MODULO PREVENTIVI ---
try:
...
if st.session_state.ruolo_utente is None:
    ...
    # ==========================================
        ...
        if sezione_selezionata == "📦 Giacenza dei Magazzini":
            ...
            else: st.info("Modulo esterno preventivi non agganciato.")
        ...
        with tab2:
            ...
            with st.form("form_fabb_standard"):
                ...
                if st.form_submit_button("Invia Segnalazione Fabbisogno"):
                    ...
                    else: st.error("Specificare il materiale.")import streamlit as st
import pandas as pd
from datetime import datetime
import io
import base64
